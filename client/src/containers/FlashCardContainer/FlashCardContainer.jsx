            ...
            this.state.started && (
              <div>
                {this.state.arrayOfQuestions.length > 0 ? (
                  <FlashCard
                    number={
                      (this.state.questionNum + 1).toString() +
                      "/" +
                      this.state.arrayOfQuestions.length.toString()
                    }
                    question={
                      this.state.arrayOfQuestions[this.state.questionNum]
                        .question
                    }
                    answers={
                      this.state.arrayOfQuestions[this.state.questionNum]
                    ...
                    goal={
                      this.state.arrayOfQuestions[this.state.questionNum].goal
                    }
                    description={
                      this.state.arrayOfQuestions[this.state.questionNum]
                        .description
                  ...
                  <h2>
                    "There were no results found for this query! Try broadening
                    your study session."
                  </h2>
                )}
              </div>
